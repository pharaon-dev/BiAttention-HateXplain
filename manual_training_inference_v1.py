...
import pandas as pd
from transformers import BertTokenizer
from Models.utils import masked_cross_entropy,fix_the_random,format_time,save_normal_model,save_bert_model, load_model
...
def select_model(params,embeddings):
    if(params['bert_tokens']):
        ...
        if(text=="birnn"):
            ...
            #model=BiCoAtt_RNN(params,embeddings,return_att=False,)
